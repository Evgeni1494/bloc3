...
def get_lat_lon(city, state, country='US'):
    """
    Get latitude and longitude for a given city and state using the OpenWeatherMap API.
...
def main():
    """
    Main function to process emissions data, add geographical coordinates, and store in a SQLite database.
    """
    # Read the CSV file
    try:
